        ...
        <View style={styles.dockRow}>
          {!readOnly && (
            <>
              ...
              >
                <MaterialCommunityIcons name="table-furniture" size={22} color="#111827" />
              ...
              >
                <MaterialCommunityIcons name="shape" size={22} color="#111827" />
              ...
              >
                <MaterialCommunityIcons name="brush" size={22} color={paintMode ? "#fff" : "#111827"} />
          ...
          >
            <MaterialCommunityIcons name="grid" size={22} color={showGrid ? "#fff" : "#111827"} />
          ...
          >
            <MaterialCommunityIcons name="magnet" size={22} color={snapToGrid ? "#fff" : "#111827"} />
          ...
          >
            <MaterialCommunityIcons name="magnify-minus" size={22} color={zoom <= MIN_ZOOM ? "#666" : "#111827"} />
          ...
          >
            <MaterialCommunityIcons name="magnify-plus" size={22} color={zoom >= MAX_ZOOM ? "#666" : "#111827"} />
            ...
            <View style={styles.rightButtons}>
              ...
              {!readOnly && (
                <TouchableOpacity
                  ...
                  disabled={saving}
                >
                  <MaterialCommunityIcons name="content-save" size={18} color="#111827" />
