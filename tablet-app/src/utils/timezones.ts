...
// Legacy export for backward compatibility - now returns full list
export const FALLBACK_TIMEZONES: string[] = getAllTimeZones();

// Legacy export - now returns full list from moment-timezone
export const getSupportedTimeZones = (): string[] => getAllTimeZones();
