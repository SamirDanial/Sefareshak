...
export default function ZoneManagementScreen() {
  ...
  const loadBranches = async () => {
    try {
      ...
      // Keep a stable selected branch for staff users
      ...
      <View style={styles.listContainer}>
        ...
        >
          ...
          <View style={styles.branchSelectorContainer}>
            ...
            {selectedBranchId && (
              <Text style={styles.branchSelectorDescription}>
                  ...
                  {loadingBranches ? (
                    ...
                    branches.map((branch) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.modalItem,
                          selectedBranchId === branch.id && styles.modalItemSelected,
                        ]}
                        onPress={() => {
                      ...
                      >
                        <Text
                          style={[
                            styles.modalItemText,
                            selectedBranchId === branch.id && styles.modalItemTextSelected,
                          ]}
                        >
