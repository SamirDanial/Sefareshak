...
export default function FloorPlanViewer({
  ...
  const handleTablePress = useCallback(
    (tableId: string) => {
      console.log("=== FLOOR PLAN VIEWER DEBUG ===");
      console.log("Table pressed:", tableId);
      console.log("Available table IDs:", availableTableIds);
      console.log("Selected table IDs:", selectedTableIds);
      ...
      if (isAvailable || isSelected) {
        console.log("Calling onTableSelect with:", tableId);
        onTableSelect(tableId);
      } else {
        console.log("Table press ignored - not available and not selected");
      }
    },
