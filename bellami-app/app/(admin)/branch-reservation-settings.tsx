...
export default function BranchReservationSettingsScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await apiService.put(`/api/admin/branches/${branchId}`, branchUpdate, token);
      ...
      >
        ...
        <View style={styles.titleSection}>
          <Text style={styles.screenTitle}>
            {t("admin.branchManagement.reservationSettings.title", { branchName }) || `Reservation Settings for ${branchName}`}
          </Text>
          <Text style={styles.screenSubtitle}>
            {t("admin.branchManagement.reservationSettings.description") || "Configure reservation settings for this branch. Fields left unchanged inherit from global settings."}
          </Text>
        </View>
