...
export default function BranchFormScreen() {
  ...
  const [orderMergeTimeframeText, setOrderMergeTimeframeText] = useState("");
    ...
    const loadSettings = async () => {
      ...
      try {
        ...
        if (settings) {
          ...
          if (!orderMergeTimeframeText && settings.orderMergeTimeframeMinutes !== undefined) {
            setOrderMergeTimeframeText(String(settings.orderMergeTimeframeMinutes));
          }
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const branchForm = {
            ...
            // Pickup/Delivery enabled (null = inherit from global, true/false = override)
            pickupEnabled: branch.pickupEnabled !== undefined ? branch.pickupEnabled : null,
            deliveryEnabled: branch.deliveryEnabled !== undefined ? branch.deliveryEnabled : null,
            ...
            pickupAcceptPayPal: (branch as any).pickupAcceptPayPal ?? false,
      ...
      >
        {isEditMode && branchName ? (
          <View style={styles.branchTitleRow}>
            <Text style={styles.screenTitle}>
              {t("admin.branchManagement.create.branchSettingsFor", { branchName }) || `Settings - ${branchName}`}
            </Text>
            <TouchableOpacity
          ...
          <View style={styles.saveButtonContainer}>
            ...
            >
              ...
              <Text style={styles.saveButtonText}>
                {t("admin.branchManagement.create.save")}
              </Text>
            </TouchableOpacity>
          </View>
        )}
            ...
            <View style={styles.addressHeader}>
              ...
              >
                ...
                <Text style={styles.gpsButtonText}>
                  {gettingLocation
                    ? t("admin.branchManagement.create.businessInformation.gettingLocation")
        ...
        >
          ...
          <NumberField
            ...
            text={orderMergeTimeframeText}
            setText={(txt) => setOrderMergeTimeframeText(updateNumber("orderMergeTimeframeMinutes", txt, false))}
