...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  if (!selectedItem) {
    ...
    return (
      <div className="w-64 bg-[#1a1a1a] border-l border-[#333] p-4 flex flex-col items-center justify-center text-gray-500">
  ...
  const effectiveElementColor = !isTable && element
      ...
      <div className="px-4 pb-4">
        ...
        <div className="space-y-3">
          ...
          {isTable && table && (
            <div className="grid grid-cols-3 gap-2">
              <div className="space-y-1">
                <Label htmlFor="tableNumber-mobile" className="text-gray-400 text-xs">
                ...
                <Input
                  ...
                  className="bg-[#262626] border-[#404040] text-white h-9 text-sm"
                />
              </div>
              <div className="space-y-1">
                <Label htmlFor="capacity-mobile" className="text-gray-400 text-xs">
              ...
              <div className="space-y-1">
                <Label htmlFor="shape-mobile" className="text-gray-400 text-xs">
                ...
                >
                  <SelectTrigger className="bg-[#262626] border-[#404040] text-white h-9 text-sm">
                    <SelectValue />
                  </SelectTrigger>
          ...
          {!isTable && element && element.elementType === "LABEL" && (
            <div className="space-y-1">
              <Label htmlFor="label-mobile" className="text-gray-400 text-xs">
          ...
          {/* Position & Size - 4 columns on mobile */}
          <div className="grid grid-cols-4 gap-2">
            ...
            <div className="space-y-1">
              <Label className="text-gray-400 text-xs">{t("admin.tableManagement.floorPlan.width")}</Label>
              <Input
                type="number"
            ...
            <div className="space-y-1">
              <Label className="text-gray-400 text-xs">{t("admin.tableManagement.floorPlan.height")}</Label>
              <Input
                type="number"
          ...
          <div className="flex items-center gap-2 pt-2">
            <Button
              ...
              className="flex-1 bg-[#262626] border-[#404040] hover:bg-[#333] text-white text-xs h-9"
            >
            ...
            <Button
              ...
              className="flex-1 bg-red-900/30 border-red-800 hover:bg-red-900/50 text-red-400 text-xs h-9"
            >
  ...
  // Desktop layout
  return (
    <div className="w-64 bg-[#1a1a1a] border-l border-[#333] p-4 overflow-y-auto">
      <div className="flex items-center gap-2 mb-4 pb-3 border-b border-[#333]">
        <Icon
          path={isTable ? mdiTableFurniture : mdiShape}
          size={0.8}
      ...
      <div className="space-y-4">
        ...
        {isTable && table && (
          <>
            <div className="space-y-2">
              <Label htmlFor="tableNumber" className="text-gray-400 text-xs">
                {t("admin.tableManagement.floorPlan.tableNumber")}
              </Label>
              <Input
                id="tableNumber"
                ...
                className="bg-[#262626] border-[#404040] text-white h-8 text-sm"
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="capacity" className="text-gray-400 text-xs">
                {t("admin.tableManagement.floorPlan.capacity")}
              </Label>
              <Input
                id="capacity"
            ...
            <div className="space-y-2">
              <Label htmlFor="shape" className="text-gray-400 text-xs">
                {t("admin.tableManagement.floorPlan.shape")}
              </Label>
              <Select
                value={table.shape}
              ...
              >
                <SelectTrigger className="bg-[#262626] border-[#404040] text-white h-8 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-[#1a1a1a] border-[#333] text-white">
                  {TABLE_SHAPES.map((shape) => (
        ...
        {!isTable && element && (
          <>
            <div className="space-y-2">
              <Label className="text-gray-400 text-xs">{t("admin.tableManagement.floorPlan.type", "Type")}</Label>
              <div className="bg-[#262626] border border-[#404040] rounded-md px-3 py-2 text-white text-sm">
                {t(`admin.tableManagement.floorPlan.elements.${element.elementType.toLowerCase()}`, element.elementType)}
              </div>
            </div>

            {(element.elementType === "LABEL" || element.label) && (
              <div className="space-y-2">
                <Label htmlFor="label" className="text-gray-400 text-xs">
                  {t("admin.tableManagement.floorPlan.labelText")}
                </Label>
                <Input
                  id="label"
            ...
            <div className="space-y-2">
              <Label htmlFor="color" className="text-gray-400 text-xs">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="bg-[#262626] border-[#404040] h-8 w-12 p-1 cursor-pointer"
                />
                <Input
                  value={effectiveElementColor}
                  onChange={(e) =>
                  ...
                  className="bg-[#262626] border-[#404040] text-white h-8 text-sm flex-1"
                />
              </div>
            </div>
          </>
        ...
        <div className="pt-3 border-t border-[#333] space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <Button
              ...
              size="sm"
              onClick={() => onRotate(selectedItem.id, selectedItem.type, 45)}
              className="bg-[#262626] border-[#404040] hover:bg-[#333] text-white text-xs"
            >
              <Icon path={mdiRotateRight} size={0.6} className="mr-1" />
              +45°
            </Button>
          ...
          <Button
            ...
            size="sm"
            onClick={() => onDelete(selectedItem.id, selectedItem.type)}
            className="w-full bg-red-900/30 border-red-800 hover:bg-red-900/50 text-red-400 text-xs"
          >
            <Icon path={mdiDelete} size={0.6} className="mr-1" />
            {t("admin.tableManagement.floorPlan.delete")}
          </Button>
