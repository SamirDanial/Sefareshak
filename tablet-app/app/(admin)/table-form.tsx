  ...
  useEffect(() => {
    const loadTableData = async () => {
      ...
      try {
        ...
        const table = response.data.find((tb) => tb.id === params.id);
        if (!table) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.loadingContainer, { paddingTop: headerHeight }]}>
          ...
          <Text style={styles.loadingText}>{t("admin.tableManagement.loading")}</Text>
        </View>
      </View>
    );
  }
    ...
    >
      ...
      >
        <View style={styles.formContainer}>
          <View style={styles.formSection}>
            <Text style={styles.inputLabel}>{t("admin.tableManagement.form.tableNumber")}</Text>
            <TextInput
              style={styles.input}
              placeholder={t("admin.tableManagement.form.tableNumberPlaceholder")}
              placeholderTextColor="#6B7280"
              value={formState.tableNumber}
              onChangeText={(text) => setFormState((prev) => ({ ...prev, tableNumber: text }))}
            />
          </View>

          <View style={styles.formSection}>
            <Text style={styles.inputLabel}>{t("admin.tableManagement.form.capacity")}</Text>
            <TextInput
              style={styles.input}
              placeholder={t("admin.tableManagement.form.capacityPlaceholder")}
              placeholderTextColor="#6B7280"
              keyboardType="numeric"
              value={formState.capacity > 0 ? String(formState.capacity) : ""}
              onChangeText={(text) => {
                if (text === "") {
            ...
            />
            <Text style={styles.inputHint}>{t("admin.tableManagement.form.capacityHint")}</Text>
          </View>
          ...
          <View style={styles.formSection}>
            <Text style={styles.inputLabel}>{t("admin.tableManagement.form.zone")}</Text>
            <TouchableOpacity
              style={[
                styles.input,
                styles.pickerInput,
            ...
            >
              ...
              >
                {!formState.branchId
                  ...
                  : formState.zoneId
                  ? availableZones.find((z) => z.id === formState.zoneId)?.name ||
              ...
              <MaterialCommunityIcons
                name="chevron-down"
                size={16}
                color={!formState.branchId ? "#6B7280" : "#9CA3AF"}
              />
            </TouchableOpacity>
            {!formState.branchId && (
              <Text style={styles.inputHint}>{t("admin.tableManagement.form.selectBranchFirst")}</Text>
            )}
          </View>

          <View style={styles.formSection}>
            <Text style={styles.inputLabel}>{t("admin.tableManagement.form.notes")}</Text>
            <TextInput
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + 12 }]}>
        <TouchableOpacity style={styles.secondaryButton} onPress={() => router.back()}>
          <Text style={styles.secondaryButtonText}>{t("admin.tableManagement.actions.cancel")}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.primaryButton,
            (!formState.tableNumber || !formState.branchId || saving) &&
        ...
        >
          {saving ? (
            ...
            <Text style={styles.primaryButtonText}>{t("admin.tableManagement.actions.save")}</Text>
          )}
        </TouchableOpacity>
      </View>
      ...
      >
        <Pressable style={styles.bottomSheetOverlay} onPress={() => setShowBranchPicker(false)}>
          <Pressable
            style={[styles.bottomSheetContent, { paddingBottom: insets.bottom + 12 }]}
            onPress={(e) => e.stopPropagation()}
          >
            <View style={styles.bottomSheetHeader}>
              <Text style={styles.bottomSheetTitle}>{t("admin.tableManagement.form.branch")}</Text>
                  ...
                  >
                    <Text
                      style={[
                        ...
                        formState.branchId === branch.id && styles.bottomSheetOptionTextActive,
                      ]}
                      numberOfLines={1}
                    >
      ...
      >
        <Pressable style={styles.bottomSheetOverlay} onPress={() => setShowZonePicker(false)}>
          <Pressable
            style={[styles.bottomSheetContent, { paddingBottom: insets.bottom + 12 }]}
            onPress={(e) => e.stopPropagation()}
          >
            <View style={styles.bottomSheetHeader}>
              <Text style={styles.bottomSheetTitle}>{t("admin.tableManagement.form.zone")}</Text>
                  ...
                  {availableZones.map((zone) => (
                    ...
                    >
                      <Text
                        style={[
                          styles.bottomSheetOptionText,
                          formState.zoneId === zone.id && styles.bottomSheetOptionTextActive,
                        ]}
                        numberOfLines={1}
                      >
                        {zone.name}
