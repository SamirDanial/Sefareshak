    ...
    >
      ...
      >
        <View style={styles.pageHeaderRow}>
          ...
          <View style={styles.headerRow}>
            <TouchableOpacity
              ...
              disabled={saving}
            >
              <MaterialCommunityIcons name="restore" size={16} color="#4b5563" />
        ...
        >
            ...
            >
              <MaterialCommunityIcons name="target" size={16} color="#111827" />
              <Text style={styles.headerButtonPrimaryText}>
            ...
            <View style={{ marginBottom: 12 }}>
              ...
              {(logoLocalUri || formData.businessLogo) ? (
                <View style={styles.imageRowCard}>
                  ...
                  >
                    <MaterialCommunityIcons name="delete" size={18} color="#111827" />
              ...
              <View style={{ marginBottom: 12 }}>
                ...
                <View style={styles.qrLinkRow}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={shareQrLink}
                  >
                    <MaterialCommunityIcons name="share" size={18} color="#111827" />
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {t("admin.settings.businessInformation.selectTimezone")}
              </Text>
...
const styles = StyleSheet.create({
  ...
  headerButtonOutlineText: { color: "#4b5563", fontWeight: "600" },
  ...
  bottomSheetOptionText: { fontSize: 15, color: "#4b5563", fontWeight: "500" },
