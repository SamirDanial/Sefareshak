...
const RoleManagement: React.FC = () => {
  ...
  const permissionModules: PermissionModule[] = [
    ...
    },
    {
      key: "dispatch",
      resource: "dispatch",
      title: t("admin.dispatch.title", { defaultValue: "Dispatch" }),
    },
    {
      key: "kitchen",
      resource: "kitchen",
      title: t("admin.kitchen.title", { defaultValue: "Kitchen" }),
    },
    {
      key: "bar",
      resource: "bar",
      title: t("admin.bar.title", { defaultValue: "Bar" }),
    },
    {
      key: "orders",
      resource: "orders",
      title: t("admin.orderManagement.title", { defaultValue: "Order Management" }),
    },
    {
      key: "menu",
      resource: "menu",
      title: t("admin.menuManagement.title", { defaultValue: "Menu Management" }),
    },
    {
      key: "deals",
      resource: "deals",
      title: t("admin.dealManagement.title", { defaultValue: "Deal Management" }),
    },
    {
      key: "categories",
      resource: "categories",
    ...
    },
    {
      key: "addons",
      resource: "addons",
      title: t("admin.addonManagement.title", { defaultValue: "Addon Management" }),
    },
    {
      key: "declarations",
    ...
    },
    {
      ...
      title: t("admin.reservationAnalytics.title", {
        defaultValue: "Reservation Analytics",
      }),
    },
  ];
  ...
  const resourceDisplayName = (resource: string) => {
    ...
    if (resource === "categories") {
      return t("admin.categoryManagement.title", {
        defaultValue: "Category Management",
      });
    }
    ...
    if (resource === "declarations") {
      return t("admin.declarationManagement.title", {
        defaultValue: "Declaration Management",
      });
    }
    if (resource === "reservations") {
      return t("admin.reservationManagement.title", {
        defaultValue: "Reservation Management",
      });
    }
    if (resource === "zones") {
    ...
    if (resource === "deliverable_quantities") {
      return t("admin.deliverableQuantities.title", {
        defaultValue: "Deliverable Quantities",
      });
    }
    if (resource === "users") {
    ...
    if (resource === "analytics_category_insights") {
      return t("admin.categoryInsights.title", {
        defaultValue: "Category Insights",
      });
    }
    if (resource === "analytics_reservation") {
      return t("admin.reservationAnalytics.title", {
        defaultValue: "Reservation Analytics",
      });
    }
    ...
    if (resource === "push_notifications") {
      return t("admin.pushNotifications.title", {
    ...
    if (resource === "policies") {
      return t("admin.termsAndPolicies.title", {
        defaultValue: "Terms & Policies",
      });
    }
    return resource;
  };
  ...
  const loadData = async () => {
    try {
      ...
      // SUPER_ADMIN must select an organization; role list is org-scoped.
      // For ORG/BRANCH users, org context is implicit and permissions should still load.
  ...
  useEffect(() => {
    const applyOrgId = (next: string | null | undefined) => {
      ...
      // Reset local UI state so dialogs/filters don't carry between orgs.
  ...
  const saveRole = async () => {
    try {
      ...
      const msg =
        ...
        e?.message ||
        t("admin.roleManagement.saveFailed", { defaultValue: "Failed to save role" });
      toast.error(msg);
    } finally {
      setRoleSaving(false);
    }
  ...
  return (
    <div className="space-y-6 p-6">
      <PageHeader
        title={t("admin.roleManagement.title", { defaultValue: "Role Management" })}
        description={t("admin.roleManagement.description", {
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center gap-2 text-sm">
                      <Checkbox
                        ...
                        onCheckedChange={() => setRoleIsActive((v) => !v)}
                      />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                              {((module.resource === "dispatch" ||
                                ...
                                <label key={action} className="flex items-center gap-2 text-sm">
                                  <Checkbox
                                    checked={(rolePermissions?.[module.resource] || []).includes(
                                      action
                                    )}
                                    onCheckedChange={() =>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <DialogContent className="bg-card border-border text-foreground max-w-md">
                      <DialogHeader>
                        <DialogTitle>
                          {t("admin.roleManagement.deleteRole", {
