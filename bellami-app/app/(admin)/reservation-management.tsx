...
export default function ReservationManagementScreen() {
  ...
  // Default to today's date range when branch is selected and no date range is already set
  useEffect(() => {
    if (!effectiveBranchId) return;
    if (startDate || endDate) return; // Only default if no range is already set
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Filters toggle */}
        <View style={{ paddingHorizontal: 28, paddingTop: 16, paddingBottom: showFilters ? 4 : 16 }}>
            <TouchableOpacity
          ...
          <View style={styles.filtersContainer}>
            ...
            >
              ...
              <Text style={styles.filterDropdownText}>
                {selectedBranchId
                  ? branches.find((b) => b.id === selectedBranchId)?.name || t("admin.reservationManagement.filters.selectBranch")
            ...
            <View style={styles.filterDropdownsRow}>
              ...
              <TouchableOpacity
                onPress={() => {
                  setDateRangePickerTarget("start");
