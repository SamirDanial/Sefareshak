        ...
        >
          ...
          {filtersLoading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              {canCreateDeal && (
                <TouchableOpacity onPress={handleCreate} style={styles.primaryCta}>
                  <MaterialCommunityIcons name="plus" size={16} color="#fff" />
                  <Text style={styles.primaryCtaText}>{t("admin.dealManagement.createFirstDeal")}</Text>
                </TouchableOpacity>
              )}
            </View>
          ) : (
        ...
        <View style={styles.sheetContainer}>
          ...
          <View style={styles.sheetHeaderRow}>
            <View style={styles.sheetHeaderLeft}>
              ...
              <Text style={styles.sheetHeaderTitle}>{actionsDeal?.name || t("admin.dealManagement.actions")}</Text>
            </View>
            <TouchableOpacity
              onPress={() => {
                setActionsModalVisible(false);
          ...
          <View style={styles.sheetContent}>
            ...
            >
              ...
              <Text style={styles.sheetItemText}>{t("common.edit")}</Text>
            </TouchableOpacity>
            ...
            >
              <MaterialCommunityIcons name={actionsDeal?.isActive ? "eye-off" : "eye"} size={16} color="#D1D5DB" />
              <Text style={styles.sheetItemText}>
                {actionsDeal?.isActive ? t("admin.dealManagement.deactivate") : t("admin.dealManagement.activate")}
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={[styles.sheetItemText, styles.sheetItemDangerText]}>{t("common.delete")}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
