...
const styles = StyleSheet.create({
  ...
  sortLabel: { fontSize: 13, color: "#9CA3AF", fontWeight: "500" },
  sortButton: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  paginationText: { fontSize: 13, color: "#9CA3AF" },
  ...
  paginationButtonDisabled: { backgroundColor: "#262626", opacity: 0.5 },
  paginationPageText: { fontSize: 13, color: "#D1D5DB", fontWeight: "500" },
  modalOverlay: {
    flex: 1,
  ...
  modalButtonCancelText: { fontSize: 14, fontWeight: "600", color: "#D1D5DB" },
  modalButtonDelete: {
    paddingHorizontal: 20,
    paddingVertical: 10,
    borderRadius: 8,
