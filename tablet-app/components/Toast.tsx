...
export function Toast({
  ...
  const backgroundColor =
    type === "success"
      ...
      ? "rgba(220, 38, 38, 1)"
      : type === "warning"
      ? "rgba(245, 158, 11, 0.95)" // Amber-500 warning color
      : "rgba(59, 130, 246, 0.95)";

  const borderColor =
    type === "error" ? "rgba(153, 27, 27, 1)" : "transparent";
  ...
  return (
    <Animated.View
      style={[
        styles.toast,
        { backgroundColor, borderColor, borderWidth: type === "error" ? 2 : 0, top: topOffset },
