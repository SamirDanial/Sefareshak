...
const styles = StyleSheet.create({
  ...
  loadingText: { color: "#111827", fontSize: 16, fontWeight: "600" },
  ...
  summaryLabel: { color: "#6b7280", fontSize: 12, fontWeight: "500" },
  summaryValue: { color: "#111827", fontSize: 18, fontWeight: "700" },
  statusGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 8,
  ...
  statusLabel: { color: "#6b7280", fontSize: 11, marginBottom: 4 },
  statusValue: { color: "#111827", fontSize: 16, fontWeight: "700" },
  chartCard: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: "#e5e7eb",
  ...
  metricDescription: { color: "#6b7280", fontSize: 12, marginTop: 6 },
  bottomSheetOverlay: {
    flex: 1,
