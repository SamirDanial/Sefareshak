...
export default function DeliverableQuantitiesScreen() {
  ...
  useEffect(() => {
    ...
    loadBranches();
  }, [selectedBranchId, getToken, t, branchLoading]);
  ...
  const refreshSizesInPlace = useCallback(async () => {
    ...
    try {
      ...
      (result.sizes || []).forEach((size) => {
        nextWeights[size.id] = size.weight !== null && size.weight !== undefined ? String(size.weight) : "";
      });
      setSizeWeights(nextWeights);
      setHasSizeWeightChanges(false);
    } catch {
      // ignore
    } finally {
  ...
  }, [getToken, selectedBranchId, selectedMealId]);
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            ...
            <Text style={styles.cardTitle}>
              {t("admin.deliverableQuantities.title", { defaultValue: "Deliverable quantities" })}
            </Text>
          </View>
          <View style={styles.cardBody}>
            <Text style={styles.emptyText}>{t("common.accessDenied")}</Text>
          </View>
        </View>
      </View>
    );
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.pageHeader}>
          <Text style={styles.pageTitle}>{t("admin.deliverableQuantities.title", { defaultValue: "Deliverable Quantities" })}</Text>
          <Text style={styles.pageSubtitle}>
            {t("admin.deliverableQuantities.description", {
              defaultValue:
