...
-- Create addons for all unique name+price combinations
INSERT INTO "addons" ("id", "name", "price", "type", "isActive", "createdAt", "updatedAt")
SELECT DISTINCT ON ("name", "price")
...
-- Delete any meal_addons that don't have a matching addon (shouldn't happen, but just in case)
DELETE FROM "meal_addons" WHERE "addOnId" IS NULL;
